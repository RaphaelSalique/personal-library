...
final class Version20200107204953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS book (id INT AUTO_INCREMENT NOT NULL, editor_id INT NOT NULL, '.
            'title '
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS book_author (book_id INT NOT NULL, author_id INT NOT NULL, INDEX '
          ...
          . 'DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS book_tag (book_id INT NOT NULL, tag_id INT NOT NULL, INDEX '.
            'IDX_F2F4CE1516A2B381'
          . ' (book_id), INDEX IDX_F2F4CE15BAD26311 (tag_id), PRIMARY KEY(book_id, tag_id)) DEFAULT CHARACTER SET '
          . 'utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A3316995AC4C FOREIGN KEY IF NOT EXISTS (editor_id) '.
            'REFERENCES '
          . 'editor (id)');
        $this->addSql('ALTER TABLE book_author ADD CONSTRAINT FK_9478D34516A2B381 FOREIGN KEY IF NOT EXISTS '.
            '(book_id) REFERENCES '
          . 'book (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE book_author ADD CONSTRAINT FK_9478D345F675F31B FOREIGN KEY IF NOT EXISTS '.
            '(author_id) '
