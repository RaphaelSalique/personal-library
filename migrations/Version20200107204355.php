...
final class Version20200107204355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS author (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, '
          . 'first_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE '
